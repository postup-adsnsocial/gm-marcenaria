...
"[project]/src/app/projetos/[id]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        "ProjectPage.useEffect": ()=>{
            async function fetchProject() {
                try {
                    ...
                    if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"] && isUUID) {
                        ...
                        if (data) {
                            ...
                            const mock = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$mock$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockProjects"].find({
                                "ProjectPage.useEffect.fetchProject.mock": (p)=>p.id === id
                            }["ProjectPage.useEffect.fetchProject.mock"]);
                        ...
                        if (mock) setProject(mock);
                        else if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"] && !isUUID) {
...
_s(ProjectPage, "HFx8IIUEGbA73kjPpd8jhxvx7kE=", false, function() {
    return [
...
//# sourceMappingURL=src_5400d65e._.js.map